<section>
	...
	<ul>
		...
		<li>
			<p>
				...
				or &quot;Our&quot; in this Agreement) refers to Pixel Mountain Creative, 2070 Washington St,
				Rossland, BC, V0G1Y0.
			</p>
		</li>
		<li>
		...
		<li>
			<p>
				<strong>Website</strong> refers to Pixel Mountain Creative, accessible from
				<a href="https://pixelmountain.ca/" rel="external nofollow noopener" target="_blank"
					>https://pixelmountain.ca/</a
				>
			</p>
		</li>
		<li>
	...
	<ul>
		<li>
			<p>By email: hello@pixelmountain.ca</p>
		</li>
		<li>
			<p>
				By visiting this page on our website: <a
					href="https://pixelmountain.ca/contact"
					rel="external nofollow noopener"
					target="_blank">https://pixelmountain.ca/contact</a
				>
			</p>
		</li>
		<li>
			<p>By phone number: +1 (250) 512-9769</p>
		</li>
		<li>
			<p>By mail: PO Box 2242, Rossland, BC, V0G1Y0, Canada</p>
		</li>
	</ul>
</section>
